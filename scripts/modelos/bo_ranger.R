# Nombre de archivo: bo_ranger.R
# Función: Crea una optimización bayesiana para random forest.

bo_ranger = function(dataset_train, dataset_test, nro_experimento, nro_iteraciones){
  library("data.table")
  library("ranger")
