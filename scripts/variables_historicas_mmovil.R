...
variables_historicas_mmovil = function(dataset, periodos, periodos_mmovil){
  library(Rcpp)
  ...
  rollear = columnas_originales_a_procesar
  ...
  dataset[, paste0(rollear, "__ravg") := frollmean(.SD, periodos_mmovil),
     .SDcols = rollear,
