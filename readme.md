...
pc_columnas = 0.05 # Con esto corre local. Si queremos usar todas las columnas igualarlo a 1.
pc_filas_train = 0.05 # Con esto corre local. Si queremos usar todas las filas igualarlo a 1.
